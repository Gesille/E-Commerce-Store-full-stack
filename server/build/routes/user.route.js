...
userRouter.get("/top-spenders", refreshTokenMiddleware, isAuthenticated, authorizeRoles("admin"), getTopSpenders);
userRouter.get("/user/most-active-users", refreshTokenMiddleware, isAuthenticated, authorizeRoles("admin"), getMostActiveUsers);
userRouter.get("/user/recent-users", refreshTokenMiddleware, isAuthenticated, authorizeRoles("admin"), getRecentUsers);
userRouter.get("/user/registrations-per-month", refreshTokenMiddleware, isAuthenticated, authorizeRoles("admin"), getRegistrationsPerMonth);
