...
productRouter.get("/dashboard/top-products", isAuthenticated, authorizeRoles("admin"), getTopSellingProducts);
// in productRouter
productRouter.get("/low-stock", isAuthenticated, authorizeRoles("admin"), getLowStockAlerts);
