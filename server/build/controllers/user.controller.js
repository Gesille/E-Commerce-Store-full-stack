...
export const getMostActiveUsers = CatchAsyncError(async (req, res, next) => {
    try {
        const users = await userModel.aggregate([
            {
                $lookup: {
...
export const getRecentUsers = CatchAsyncError(async (req, res, next) => {
    try {
...
// user.controller.ts
export const getRegistrationsPerMonth = CatchAsyncError(async (req, res, next) => {
    try {
...
export const managerRegisterUser = CatchAsyncError(async (req, res, next) => {
