          ...
          {isFetching ? (
            ...
            <div className="px-4 pb-4">
              {data.movements.map((m: any) => (
                <div
                  key={m._id}
                  className="flex items-center gap-2.5 py-2 border-b border-gray-50"
                >
                  <span
                  ...
                  <span
                    className={`text-[13px] font-semibold min-w-[28px] ${
...
export default function InventoryPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── KPI strip ── */}
      <div
        className="shrink-0 grid border-b border-gray-100 bg-white"
        ...
        {tab === "products" && (
          <div className="flex items-center gap-2 ml-auto py-1.5">
            <div className="relative">
              <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-300 text-[12px]">
                🔍
              </span>
              <input
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {tab === "products" && (
          <div className="p-4">
            {invLoading ? (
              <div className="py-16 text-center text-[12px] text-gray-400 animate-pulse">
                Loading inventory…
              </div>
            ) : (
                        ...
                        >
                          ...
                          <td
                            className={`px-3 py-2.5 text-[12px] font-semibold tabular-nums ${
                              p.sold > 0 ? "text-red-500" : "text-gray-300"
                            }`}
                          >
                            {p.sold > 0 ? `-${p.sold}` : "0"}
                          </td>
                  ...
                  <tbody>
                    {movData.movements.map((m: any) => (
                      <tr key={m._id} className="border-b border-gray-50 hover:bg-gray-50">
                        ...
                        <td className="px-3 py-2.5 text-[12px] font-medium text-gray-800 max-w-[180px] truncate">
                          {m.productName}
                        </td>
                        <td
                          className={`px-3 py-2.5 text-[12px] font-semibold tabular-nums ${
            ...
            {invLoading ? (
              ...
              <>
                <div className="bg-white rounded-xl border border-gray-100 p-4">
                  <div className="text-[12px] font-semibold text-gray-600 mb-4">
                ...
                <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                  <div className="px-4 py-3 border-b border-gray-100 text-[12px] font-semibold text-gray-600">
                    4-week summary
                  </div>
                  <table className="w-full border-collapse">
                    <thead>
                    ...
                    <tbody>
                      {(inv?.weekly ?? []).map((w: any) => (
                        <tr key={w.weekLabel} className="border-b border-gray-50">
                          ...
                          <td className="px-3 py-2.5 text-[12px] font-semibold text-red-500 tabular-nums">
                            {w.sold}
                          </td>
                          <td className="px-3 py-2.5 text-[12px] font-semibold text-emerald-600 tabular-nums">
                            {w.returned}
                          </td>
                          <td
                            className={`px-3 py-2.5 text-[12px] font-semibold tabular-nums ${
