...
export default function POSClosingReport() {
  ...
  // ── Denominations — persisted per date in localStorage ────────────────────
  ...
  // Load saved denominations whenever selected date changes
  useEffect(() => {
    try {
  ...
  // Save denominations to localStorage on every change
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            ...
            <div className="flex items-center gap-4 mt-3 text-[10px] text-gray-400">
              ...
              <span className="flex items-center gap-1">
                <span className="w-2.5 h-2.5 rounded-sm bg-gray-100 inline-block" /> Closed
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-gray-900 tabular-nums">${fmt(monthTotals.netSales)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Total Orders</span>
                <span className="font-bold text-gray-900 tabular-nums">{monthTotals.ordersCount.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Active Days</span>
                <span className="font-bold text-gray-900">{monthTotals.activeDays}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Avg / Day</span>
                <span className="font-bold text-gray-900 tabular-nums">${fmt(monthTotals.avgPerDay)}</span>
              </div>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <KpiCard label="Tax Collected" value={report.tax}           sub="VAT"                          icon={<ReceiptText size={14} className="text-amber-600"  />} color="bg-amber-50"   />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                  <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-4">Sales Breakdown</h3>
                ...
                {/* Payment methods */}
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                  <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-4">Payment Methods</h3>
                  <div className="flex flex-col gap-4">
                    <PaymentBar label="Cash"              amount={report.payments.cash}  total={report.payments.total} color="bg-emerald-400" icon={<Banknote    size={14} className="text-emerald-600" />} />
                    <PaymentBar label="Credit / Debit Card" amount={report.payments.card} total={report.payments.total} color="bg-blue-400"    icon={<CreditCard  size={14} className="text-blue-600"    />} />
                    <PaymentBar label="Bank Transfer"     amount={report.payments.bank}  total={report.payments.total} color="bg-violet-400"  icon={<Building2   size={14} className="text-violet-600"  />} />
                    <PaymentBar label="Check"             amount={report.payments.check} total={report.payments.total} color="bg-amber-400"   icon={<ReceiptText size={14} className="text-amber-600"   />} />
                    {report.payments.other > 0 && (
                      <PaymentBar label="Other" amount={report.payments.other} total={report.payments.total} color="bg-gray-400" icon={<CreditCard size={14} className="text-gray-600" />} />
                    )}
                  </div>
              ...
              {report.topProducts?.length > 0 && (
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                  <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-4">Top Products</h3>
                  <div className="flex flex-col gap-0">
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    {/* Error message shown directly under the button */}
                    {submitError && (
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex justify-between items-center py-2.5 border-b border-gray-50 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        <Clock size={13} className="text-gray-400" /> Opening Balance
                      </div>
                      <span className="font-semibold tabular-nums text-gray-900">${fmt(report.openingBalance)}</span>
                    </div>
                    <div className="flex justify-between items-center py-2.5 border-b border-gray-50 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        <Banknote size={13} className="text-emerald-500" /> Cash Sales
                      </div>
                      <span className="font-semibold tabular-nums text-emerald-700">+${fmt(report.payments.cash)}</span>
                    </div>
                    <div className="flex justify-between items-center py-2.5 border-b border-gray-50 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        <XCircle size={13} className="text-red-400" /> Cash Refunds (est.)
                      </div>
                      <span className="font-semibold tabular-nums text-red-500">-${fmt(report.refunds * 0.45)}</span>
                    </div>
