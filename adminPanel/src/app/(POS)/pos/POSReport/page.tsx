    ...
    <div id="printable-report" className="font-sans text-gray-900 text-sm">
      ...
      <div className="mb-4 border-b border-dashed border-gray-300 pb-4">
        ...
        <div className="space-y-1 text-sm mb-3">
          ...
          <div
            className={`flex justify-between font-bold border-t border-gray-300 pt-1 ${Math.abs(denomTotal - report.expectedClosingBalance) < 1 ? "text-emerald-700" : "text-red-600"}`}
          >
...
export default function POSClosingReport() {
  ...
  // Save to Odoo (calls existing submit endpoint — same flow, just UI feedback)
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      />
                      <PaymentBar
                        label="Visa / Master Card/ Amex Card"
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-0">
                      ...
                      <div className="flex justify-between items-center py-2 text-sm">
                        ...
                        <span
                          className={`font-extrabold tabular-nums ${Math.abs(denomTotal - report.expectedClosingBalance) < 1 ? "text-emerald-700" : "text-red-500"}`}
                        >
                          ${fmt(denomTotal)}
                        </span>
                      </div>
                      <div
                        className={`flex justify-between items-center py-2.5 rounded-xl px-3 text-sm mt-1 ${Math.abs(denomTotal - report.expectedClosingBalance) < 1 ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-600"}`}
                      >
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          ...
                          <tr className="border-t-2 border-gray-200 bg-gray-50">
                            <td
                              colSpan={2}
                              className="py-3 pl-4 text-sm font-extrabold text-gray-900"
                            >
                              Total Cash
                            </td>
