    ...
    <SheetContent className="w-[440px] sm:w-[520px] p-0 bg-gradient-to-b from-indigo-50 via-white to-purple-50 dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-900">
      <SheetHeader className="p-6 bg-blue-50 border-b border-blue-100 text-slate-900">
        ...
        <p className="text-sm text-slate-500">
          Fill all fields to sync with Odoo correctly
        </p>
      </SheetHeader>
            ...
            <Section title="Product Identity">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        className="bg-white border-indigo-200 rounded-lg"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Stored as <code>default_code</code> in Odoo
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Overrides Reference in Odoo if provided
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-indigo-700">
                      <Edit3 size={14} /> Short Description *
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
            ...
            <Section title="Pricing & Cost">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Shown to customers (<code>list_price</code>)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-emerald-700">
                      <ShoppingCart size={14} /> Supplier Price
                    </FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                    ...
                    <FormDescription>
                      Cost price in selected currency (
                      <code>standard_price</code>)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
    ...
    <span className="text-sm text-slate-600">Use final price as sale price</span>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Applied via <code>stock.quant</code> inventory adjustment
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                      ...
                      <SelectContent>
                        {categories.map((cat: any) => (
                          <SelectItem
                            ...
                            value={String(cat.odooCategoryId)}
                          >
                            {cat.catTitle}
                          </SelectItem>
                        ))}
            ...
            <Section title="Storage Location">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-sky-700">
                      <MapPin size={14} /> Shelf Name
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="e.g. Shelf A"
                        className="bg-white border-sky-200 rounded-lg"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-sky-700">
                      <Building2 size={14} /> Warehouse Name
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-orange-600">
                      <User size={14} /> Supplier Invoice #
                    </FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="e.g. INV-2024-001"
                        className="bg-white border-orange-200 rounded-lg"
                      />
                    </FormControl>
                    <FormDescription>
                      Shared invoice reference across products
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Stored in MongoDB only (display label)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-3 mt-2">
                          {colors.map((color) => (
                            <label
                              key={color}
                              className="flex items-center gap-2 p-2 rounded-md border bg-white border-indigo-100 cursor-pointer hover:bg-indigo-50 transition"
                            >
                              <Checkbox
                        ...
                        {field.value && field.value.length > 0 && (
                          <div className="space-y-3 pt-2 border-t border-indigo-100">
                            ...
                            {field.value.map((color) => (
                              <div
                                key={color}
                                className="flex items-center gap-3 p-2 rounded-md border border-indigo-100 bg-white"
                              >
                                <div
                                  className="w-4 h-4 rounded-full border"
                                  style={{ backgroundColor: color }}
                                />
                                <span className="text-sm capitalize text-slate-700 w-20">
                                  {color}
                                </span>
